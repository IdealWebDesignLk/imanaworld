...
define( 'IPN_VERSION', '0.9.45' );
define( 'IPN_DB_VERSION', '1.3.0' );
...
require_once IPN_PLUGIN_DIR . 'classes/class-ipn-single-vendor-cart.php';
...
require_once IPN_PLUGIN_DIR . 'classes/class-ipn-theme.php';
require_once IPN_PLUGIN_DIR . 'classes/class-ipn-data-reset.php';
require_once IPN_PLUGIN_DIR . 'classes/class-ipn-product-guard.php';
